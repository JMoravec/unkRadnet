#    Version info: $Id: Test_OutputSourceCodeService.py 1 2012-01-07 22:20:43Z zunzun.com@gmail.com $
...
\ttemp = temp - Application.WorksheetFunction.log(temp)
\ttemp = Application.WorksheetFunction.log10(temp)
\ttemp = Exp(temp)
\ttemp = sin(temp)
\ttemp = cos(temp)
\ttemp = tan(temp)
