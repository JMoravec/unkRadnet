#! /usr/bin/python
#    Version info: $Id: UserDefinedFunction3D.py 258 2010-09-14 18:37:07Z zunzun.com $
...
equation = pythonequations.Equations3D.UserDefinedFunction.UserDefinedFunction3D()


# define and parse user function before fitting
# in this example coefficients are named Coeff_1, Temperature and Pressure
# data must be named as X and Y, so these are reserved and cannot be used as coefficient names
equation.userDefinedFunctionText = 'Coeff_1 * X + 51.0 + pi ** e - Y * Temperature + Pressure'
