#! /usr/bin/python
#    Version info: $Id: NeuralNetwork2D.py 314 2011-07-11 08:50:50Z zunzun.com $
'''
...
neuralNetwork = pythonequations.Equations2D.NeuralNetwork.NeuralNetwork2D()
...
neuralNetwork.hiddenNodeCountLayer_2 = 0 # how many hidden nodes in the second hidden layer?
...
for i in range(len(neuralNetwork.DependentDataArray)):
    ...
    print 'Y', neuralNetwork.DependentDataArray[i],
